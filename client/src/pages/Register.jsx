  ...
  return (
    <div className="max-w-md mx-auto px-4 sm:px-6 py-20 sm:py-24">
      ...
      >
        ...
        <h1 className="font-body text-3xl sm:text-4xl text-ink mb-10 leading-tight">Create your account</h1>
        ...
        <div className="mt-10 pt-8 border-t border-ink/10 text-center">
          <p className="font-display text-xs uppercase tracking-widest text-ink/50">
            ...
            <Link to="/login" className="text-indigo font-600 hover:text-ink transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-indigo rounded-sm px-1">
              Sign in
            </Link>
          </p>
        </div>
